...
public:
	...
	Shader(std::string ShaderName, const char* vertexPath, const char* tessConPath, const char* tessEvaPath, const char* fragmentPath, const char* geometryPath = nullptr);
